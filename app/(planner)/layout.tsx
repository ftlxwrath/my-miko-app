    ...
    <div className="min-h-screen bg-[#fff6f6] text-[#2b1616]">
      <div className="relative overflow-hidden">
        ...
        <div className="relative mx-auto flex max-w-6xl flex-col gap-8 px-6 pb-16 pt-10 md:px-10">
          <nav className="flex flex-wrap items-center gap-3 text-sm font-semibold uppercase tracking-[0.3em] text-[#7b4c4c]">
            <Link
              className="rounded-full border border-[#f1d6d6] bg-white px-5 py-2 text-[#7b4c4c] shadow-sm transition hover:border-[#b34343] hover:text-[#2b1616]"
              href="/"
            >
              Home
            </Link>
